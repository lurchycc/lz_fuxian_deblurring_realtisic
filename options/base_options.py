...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--load_pretrained_BGAN',type=bool,default=True,help='loading pretrained model')
        ...
        parser.add_argument('--epoch', type=str, default='140', help='which epoch to load? set to latest to use latest cached model')
